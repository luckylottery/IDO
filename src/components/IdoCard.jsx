      ...
      <div className="w-400 h-fit border-2 border-green4 rounded-2xl bg-gray1 bg-opacity-50 p-40">
        <div className="flex flex-col">
          <div className="flex justify-between">
            <div className="flex flex-col">
              <p className="text-18 text-green4 flex justify-start">Xxertyoi</p>
          ...
          <div className="w-full bg-gray1 rounded-full h-10 dark:bg-gray-700">
            <div className="bg-green1 h-10 rounded-full" style={{ width: "45%" }}></div>
          </div>
          ...
          <div className="flex justify-between items-end">
            ...
            <p className="text-green1 text-20 font-medium">Mar 1,2022 3:00 RM UTC</p>
          </div>
        </div>
      </div>
    </>
